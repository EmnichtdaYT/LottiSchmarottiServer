...
public enum OutputType {
	ACKNOWLEDGMENT(0), INITIAL_INFORMATION(1), ROLL_QUESTION(2), SERVER_SHUTDOWN(21), CONNECTED_CLIENT_INFO(22), SERVER_TIMEOUT(23), CHARACTER_INFO(24), GENERAL_ERROR(40), CONNECTION_TIMEOUT(41);
